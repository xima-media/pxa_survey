#
# Table structure for table 'tx_pxasurvey_domain_model_doubleoptin'
#
CREATE TABLE tx_pxasurvey_domain_model_doubleoptin (
    ...
    bestaetigt tinyint(4) unsigned DEFAULT '0' NOT NULL,

    PRIMARY KEY (uid),
    KEY parent (pid),
    KEY code (verification_code)
